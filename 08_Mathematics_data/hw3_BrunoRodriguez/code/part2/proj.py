...
# own implementation of the projection onto the nuclear norm. This is not used to create the plots
def proj_nuc(Z, kappa):
    ...
    S_l = projL1(S, s=kappa)
    S_l = np.diag(S_l) # create matrix Sl1
    proj_Z = U@ S_l @Vt # equation Q-1.1 c)
    return proj_Z

# temp = np.array([1, 2, 3])
# temp = np.array([0.814723686393179,	0.905791937075619,	0.126986816293506,	0.913375856139019,	0.632359246225410,	0.0975404049994095,	0.278498218867048,	0.546881519204984,	0.957506835434298,	0.964888535199277])
# print temp
# pTemp = projL1(temp, 10)
# print pTemp
