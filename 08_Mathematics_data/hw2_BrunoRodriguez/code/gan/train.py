# note: this codes runs with cuda as default
...
def main(args):
    ...
    f_optim = Adam(f.parameters(), betas=(0.0, 0.9)) # call ADAM optimizer
    g_optim = Adam(g.parameters(), betas=(0.0, 0.9))

    # Initialize trainer
    trainer = GanTrainer(
            args.batch_size, data=data, noise=noise,
    ...
    trainer.alternating(
            ...
            n_checkpoints=4)
    trainer.render_gif(
            'movie' +  '.gif', duration=0.1)     

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    # training parameters
    parser.add_argument('--batch_size', type=int, default=200)
    parser.add_argument('--n_iter', type=int, default=400) # this is the default value
    parser.add_argument('--hidden_dim', type=int, default=100) # this is the default value
